...
BEGIN
    ...
    DECLARE @RACHUNEK_NOWY_ID bigint;

    SELECT @RACHUNEK_NOWY_ID = RACHUNEK.ID_RACHUNEK FROM RACHUNEK WHERE @ID_NAJEM = @ID_NAJEM;

    UPDATE NAJEM_INDYWIDUALNY SET ID_RACHUNEK = @RACHUNEK_NOWY_ID WHERE ID_NAJEM = @ID_NAJEM;
